...
OPP_PRODUCTION_INDEX_IMAGE_TAG_TYPE="$(echo $OPP_PRODUCTION_INDEX_IMAGE_TAG | cut -d '-' -f 2)"
OPP_MIRROR_INDEX_MULTIARCH_POSTFIX_FINAL=$OPP_MIRROR_INDEX_MULTIARCH_POSTFIX
[[ $OPP_PRODUCTION_INDEX_IMAGE_TAG_TYPE == *db* ]] || OPP_MIRROR_INDEX_MULTIARCH_POSTFIX_FINAL="${OPP_MIRROR_INDEX_MULTIARCH_POSTFIX_FINAL}f"
...
echo "OPP_PRODUCTION_INDEX_IMAGE_TAG=$OPP_PRODUCTION_INDEX_IMAGE_TAG"
echo "OPP_PRODUCTION_INDEX_IMAGE_TAG_TYPE=$OPP_PRODUCTION_INDEX_IMAGE_TAG_TYPE"
echo "OPP_MIRROR_INDEX_MULTIARCH_POSTFIX=$OPP_MIRROR_INDEX_MULTIARCH_POSTFIX"
