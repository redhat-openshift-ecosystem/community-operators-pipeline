...
function ExecParameters() {
    ...
    [[ $1 == orange* ]] && [[ $OPP_PROD -eq 0 ]] && [[ $OPP_INSTALLATION_SKIP -eq 1 ]] && OPP_EXEC_USER="$OPP_EXEC_USER -e production_index=$OPP_PRODUCTION_REGISTRY_NAMESPACE/$OPP_RELEASE_INDEX_NAME"
